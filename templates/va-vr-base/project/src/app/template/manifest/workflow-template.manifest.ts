import { WorkflowTemplateManifest } from '@template/types/template.types';
import { WORKFLOW_STEPS } from '../config/workflow-steps.config';
import { WORKFLOW_PRESETS } from '../config/workflow-presets.config';
import { UI_BLOCKS } from '../config/ui-blocks.config';
import { UI_BLOCK_INSTANCES } from '../config/ui-block-instances.config';
import { FIELD_SCHEMAS } from '../config/field-schemas.config';
import { PROCESS_VARIABLES } from '../config/process-variables.config';
import { WORKFLOW_ROUTES } from '../config/workflow-routes.config';
import { DEPENDENCY_RULES } from '../config/dependencies.config';
